...
export default function HeroContent({
  ...
  return (
    <div className="relative z-20 flex flex-col justify-center max-w-[660px] pt-24 sm:pt-28 pb-12 lg:py-16 text-left select-none animate-fadeIn">
      ...
      <div className="inline-flex items-center space-x-2.5 px-4 py-1.5 rounded-full bg-white/90 backdrop-blur-md border border-[#E8DCCB] shadow-xs mb-4 w-max">
        <span className="w-2.5 h-2.5 rounded-full bg-[#89190E] animate-pulse-beacon" />
      ...
      {/* Main Serif Headline */}
      <h1 className="font-serif text-[46px] sm:text-[62px] lg:text-[72px] leading-[0.98] sm:leading-[1.0] font-bold text-[#10233F] tracking-tight mb-2">
      ...
      <p className="mt-6 sm:mt-8 text-[#10233F] text-[16px] sm:text-[19px] leading-[1.5] max-w-[500px] font-normal">
      ...
      <div className="flex flex-wrap items-center gap-4 sm:gap-5 mt-7 sm:mt-8">
        ...
        <button
          ...
          className="group h-[52px] sm:h-[56px] px-7 sm:px-8 bg-[#89190E] hover:bg-[#65130D] text-white font-semibold text-[15px] sm:text-[16px] rounded-[14px] flex items-center justify-center space-x-2.5 shadow-xl shadow-[#89190E]/25 btn-hover-lift active:scale-98"
        >
        ...
        <button
          onClick={onOpenVideo}
          className="group h-[52px] sm:h-[56px] px-6 sm:px-7 bg-[#FFF9EF]/95 hover:bg-white text-[#89190E] font-semibold text-[15px] sm:text-[16px] rounded-[14px] border-2 border-[#89190E]/40 hover:border-[#89190E] flex items-center justify-center space-x-2.5 transition-all duration-200 shadow-sm hover:shadow active:scale-98"
        >
